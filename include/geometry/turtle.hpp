...
public:
  ...
  std::vector<Turtle*> children; /*!< List of child turtles starting at end position of this turtle. */
  Turtle* parent;                /*!< Turtle which created this. */
  bool complete;                 /*!< Has the turtle finished moving */

  Turtle();
  Turtle(Turtle& turtle);
  Turtle(TVector3 initialPosition, TVector3 initialOrientation, TVector3 initialLVector);
  ~Turtle();
  void move();
