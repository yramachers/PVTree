...
template <class T>
inline _Option::Result convert(const std::string& nm_s, T& result,
...
class _OptionT<std::vector<T> > : public _OptionTBase<std::vector<T> > {
 ...
 public:
  ...
  _OptionT(char nm_short_opt, const std::string& nm_long_opt,
           std::vector<T>& nm_target)
...
class _DefValOption : public BaseOption {
 ...
 public:
  ...
  _DefValOption(char nm_short_opt, const std::string& nm_long_opt, T& nm_target,
                const T& nm_default_value)
      : BaseOption(nm_short_opt, nm_long_opt, nm_target),
        default_value(nm_default_value) {}
...
class _GlobalOption : public _Option {
 ...
 public:
  ...
  _GlobalOption(T& nm_target) : target(nm_target) {}
};
...
class _GlobalOption<std::vector<T> > : public _Option {
 ...
 public:
  ...
  _GlobalOption(std::vector<T>& nm_target) : target(nm_target) {}
};

template <class T>
inline _OptionT<T> Option(char nm_short_opt, const std::string& nm_long_opt,
                          T& nm_target) {
...
class GetOpt_pp {
 ...
 public:
  ...
  void flags(std::ios::fmtflags nm_flags) { _flags = nm_flags; }
