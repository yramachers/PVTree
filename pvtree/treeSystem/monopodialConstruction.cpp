...
/*! \brief Construct a Monopodial L-System constructor. Here the default parameters and their 
 *         ranges are set.
 */
 ...
 *
 */
std::vector<std::shared_ptr<TreeSystemInterface> > MonopodialConstruction::getInitialConditions() {

  std::vector<std::shared_ptr<TreeSystemInterface> > treeConditions;

  treeConditions.push_back( std::shared_ptr<TreeSystemInterface>( new MonopodialBranching::Slash(this, getDoubleParameter("initialOrientation"))  ) );
  treeConditions.push_back( std::shared_ptr<TreeSystemInterface>( new MonopodialBranching::A(this, getDoubleParameter("initialHeight"), getDoubleParameter("initialWidth"))  ) );
