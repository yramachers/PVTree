 ...
 *         properties
 */
bool TreeConstructionInterface::operator==(const TreeConstructionInterface& right) {
 ...
 */
void TreeConstructionInterface::setRandomParameterRange(std::string name, double minValue, double maxValue) {
 ...
 * @param[in] maxValue  The maximum value allowed for the parameter.
 */
void TreeConstructionInterface::setRandomParameterRange(std::string name, int minValue, int maxValue) {
 ...
 * \throws std::invalid_argument   If a parameter with the given name and type doesn't exist.
 */
std::pair<double, double> TreeConstructionInterface::getDoubleRange(std::string name) const {
 ...
 * \throws std::invalid_argument   If a parameter with the given name and type doesn't exist.
 */
std::pair<int, int> TreeConstructionInterface::getIntegerRange(std::string name) const {
 ...
 *
 */
std::vector<std::string>  TreeConstructionInterface::getDoubleParameterNames() const {
 ...
 *
 */
std::vector<std::string>  TreeConstructionInterface::getIntegerParameterNames() const {
 ...
 *
 */
bool TreeConstructionInterface::openConfigurationFile(std::string fileName, libconfig::Config& cfg) {
 ...
 *
 */
void TreeConstructionInterface::applyConfigurationFile(std::string configurationFileName) {
