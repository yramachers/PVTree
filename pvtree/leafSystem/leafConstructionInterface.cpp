 ...
 *         properties
 */
bool LeafConstructionInterface::operator==(
    const LeafConstructionInterface& right) {
 ...
 */
void LeafConstructionInterface::setRandomParameterRange(std::string name,
                                                        double minValue,
                                                        double maxValue) {
 ...
 *doesn't exist.
 */
std::pair<double, double> LeafConstructionInterface::getDoubleRange(
 ...
 *doesn't exist.
 */
std::pair<int, int> LeafConstructionInterface::getIntegerRange(
    std::string name) const {
  auto mapIterator = m_integerParameterRanges.find(name);
 ...
 *
 */
std::vector<std::string> LeafConstructionInterface::getDoubleParameterNames()
    const {
 ...
 *
 */
std::vector<std::string> LeafConstructionInterface::getIntegerParameterNames()
    const {
 ...
 *
 */
bool LeafConstructionInterface::openConfigurationFile(std::string fileName,
 ...
 *
 */
void LeafConstructionInterface::applyConfigurationFile(
