...
public:
  ...
  /*! \brief To construct this base class it is necessary to pass a construction interface.
   */ 
  explicit LeafSystemInterface(LeafConstructionInterface* constructor) : m_constructor(constructor) {};
  ...
  /*! \brief Function needed to translate the symbol into a behviour in 3D space.
   ...
   *                           where the last polygon is being actively constructed.
   */
