    ...
    if (thePostPoint->GetStepStatus() == fGeomBoundary) {
      if (m_expectedNextStatus == StepTooSmall) {
        if (boundaryStatus != StepTooSmall) {
          ...
          G4Exception("full::SteppingAction::UserSteppingAction()",
                      "FullSimulation", FatalException, ed,
	  ...
	  //	  G4cout << "Absorption by " << thePostPV->GetName() << G4endl;
        ...
        case Detection: {
          ...
          if (thePostPV->GetName() == "LeafSensitive") {
            ...
            LeafTrackerSD* trackerSD =
                static_cast<LeafTrackerSD*>(SDman->FindSensitiveDetector(
        ...
        case BackScattering:
          // 	G4cout << "Back scattering by " << thePostPV->GetName() <<
          // G4endl;
...
G4bool SteppingAction::GetOneStepPrimaries() { return m_oneStepPrimaries; }
