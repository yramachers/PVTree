...
set(rootlibs Core Cint RIO Net Hist Graf Graf3d Gpad Tree Rint Postscript Matrix Physics MathCore Thread Geom MathMore )
set(ROOT_LIBRARIES)
...
function(ROOT_GENERATE_DICTIONARY dictionary)
  ...
  foreach(fp ${ARG_UNPARSED_ARGUMENTS})
    if(${fp} MATCHES "[*?]") # Is this header a globbing expression?
      ...
      find_file(headerFile ${fp} PATHS ${incdirs} NO_DEFAULT_PATH)
  ...
  foreach( f ${ARG_LINKDEF})
    find_file(linkFile ${f} PATHS ${incdirs} NO_DEFAULT_PATH)
