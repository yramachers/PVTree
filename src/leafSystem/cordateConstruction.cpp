...
/*! \brief Construct a Cordate L-System constructor. Here the default parameters and their 
 *         ranges are set.
 */
 ...
 *
 */
std::vector<std::shared_ptr<LeafSystemInterface> > CordateConstruction::getInitialConditions() {

  std::vector<std::shared_ptr<LeafSystemInterface> > leafConditions;

  leafConditions.push_back( std::shared_ptr<LeafSystemInterface>(new Cordate::Slash(this, getDoubleParameter("initialAngle") )) );
  leafConditions.push_back( std::shared_ptr<LeafSystemInterface>(new Cordate::G(this, getDoubleParameter("stemLength") )) );
  leafConditions.push_back( std::shared_ptr<LeafSystemInterface>(new Cordate::LeftBracket(this)) );
  leafConditions.push_back( std::shared_ptr<LeafSystemInterface>(new Cordate::A(this, 1.0)) );
  leafConditions.push_back( std::shared_ptr<LeafSystemInterface>(new Cordate::RightBracket(this)) );
  leafConditions.push_back( std::shared_ptr<LeafSystemInterface>(new Cordate::LeftBracket(this)) );
  leafConditions.push_back( std::shared_ptr<LeafSystemInterface>(new Cordate::B(this, 1.0)) );
  leafConditions.push_back( std::shared_ptr<LeafSystemInterface>(new Cordate::RightBracket(this)) );
