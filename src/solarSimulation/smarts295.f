...
c     Conversion of smarts to a subroutine
c
      subroutine runsmarts()
...
c     Define some extra variables as double precision
c      Double Precision To32,rz0,rz1,Thick,Rpz9,Rpz5,UOC,testx,phir,cphi
c      Double Precision sphi,cosaz,SolarH,Abo3,xamw,tphi,q,azr,cosom0
c      Double Precision SINH0,zcos,Azim,Radius,om0,sq,H0hd,zr
c      Double Precision AmO3
c,AmNO2,AmNO,AmN2,AmCO,AmCH4,AmN2O,AmNH3
c      Double Precision AmSO2,AmHNO3,AmAER,AmPOL
      Double Precision radius,eot
...
c
      CHARACTER(len=500) :: shareDirectoryPath, dataDirectoryPath
      CHARACTER*100 FileOut,FileExt,FileScn
      ...
      Common /Pathing/ dataDirectoryPath
...
ccccccccccccccccc Input parameter passing cccccccccccccccccccccccccccc
c     Additional control options
      Integer verbosity,errorVerbosity,debugVerbosity,allVerbosity
      Integer writeOutputFiles
      Common /generalsmarts/ verbosity,writeOutputFiles

c     Card 1 Input
      Character(len=64) c1comment      
      Common /inputcard1/ c1comment

c     Card 2 Input
      Double Precision c2pressure,c2altitude,c2height,c2latitude
      Integer c2mode
      Common /inputcard2/c2pressure,c2altitude,c2height,c2latitude,
     &     c2mode

c     Card 3 Input
      Double Precision c3temperature,c3relativehumidity,
     &     c3dailytemperature
      Character(len=6) c3season
      Character(len=4) c3reference
      Integer c3mode
      Common /inputcard3/c3temperature,c3relativehumidity,
     &     c3dailytemperature,c3mode,c3season,c3reference

c     Card 4 Input
      Double Precision c4precipitablewater
      Integer c4mode
      Common /inputcard4/c4precipitablewater,c4mode

c     Card 5 Input
      Double Precision c5ozoneTotalAbundance
      Integer c5mode, c5altitudeCorrectionMode
      Common /inputcard5/c5ozoneTotalAbundance,c5altitudeCorrectionMode,
     &     c5mode

c     Card 6 Input
      Double Precision c6formaldehydeConcentration
      Double Precision c6methaneConcentration
      Double Precision c6carbonMonoxideConcentration
      Double Precision c6nitrousAcidConcentration
      Double Precision c6nitricAcidConcentration
      Double Precision c6nitricOxideConcentration
      Double Precision c6nitrogenDioxideConcentration
      Double Precision c6nitrogenTrioxideConcentration
      Double Precision c6ozoneConcentration
      Double Precision c6sulfurDioxideConcentration
      Integer c6loadMode
      Integer c6mode
      Common /inputcard6/c6formaldehydeConcentration,
     &     c6methaneConcentration,c6carbonMonoxideConcentration,
     &     c6nitrousAcidConcentration,c6nitricAcidConcentration,
     &     c6nitricOxideConcentration,
     &     c6nitrogenDioxideConcentration,
     &     c6nitrogenTrioxideConcentration,
     &     c6ozoneConcentration,c6sulfurDioxideConcentration,
     &     c6loadMode,c6mode

c     Card 7 Input
      Double Precision c7carbonDioxideConcentration
      Common /inputcard7/c7carbonDioxideConcentration

c     Card 7a Input
      Integer c7extraterrestrialSpectrum
      Common /inputcard7a/c7extraterrestrialSpectrum

c     Card 8 Input
      Double Precision c8alphaShortWavelength,c8alphaLongWavelength
      Double Precision c8singleScatteringAlbedo,c8aerosolAsymmetry
      Character(len=64) c8aerosolModel
      Common /inputcard8/c8alphaShortWavelength,c8alphaLongWavelength,
     &     c8singleScatteringAlbedo,c8aerosolAsymmetry,c8aerosolModel

c     Card 9 Input
      Double Precision c9aerosolOpticalDepth500
      Double Precision c9angstromTurbidityCoefficient
      Double Precision c9schueppTurbidityCoefficient
      Double Precision c9meteorologicalRange
      Double Precision c9prevailingVisibility
      Double Precision c9aerosolOpticalDepth550
      Integer c9mode
      Common /inputcard9/c9aerosolOpticalDepth500,
     &     c9angstromTurbidityCoefficient,c9schueppTurbidityCoefficient,
     &     c9meteorologicalRange,c9prevailingVisibility,
     &     c9aerosolOpticalDepth550,c9mode

c     Card 10 Input
      Double Precision c10broadbandLambertianAlbedo
      Integer c10mode
      Common /inputcard10/c10broadbandLambertianAlbedo,c10mode

c     Card 10b Input
      Double Precision c10btiltAngle,c10bsurfaceAzimuth
      Double Precision c10bforegroundAlbedo
      Integer c10bforegroundAlbedoMode,c10bmode
      Common /inputcard10b/c10btiltAngle,c10bsurfaceAzimuth,
     &     c10bforegroundAlbedo,c10bforegroundAlbedoMode,c10bmode

c     Card 11 Input
      Double Precision c11minWavelength,c11maxWavelength
      Double Precision c11sunCorrectionFactor,c11solarConstant
      Common /inputcard11/c11minWavelength,c11maxWavelength,
     &     c11sunCorrectionFactor,c11solarConstant

c     Card 12 Input
      Double Precision c12minWavelength,c12maxWavelength
      Double Precision c12wavelengthInterval
      Integer c12numberOfOutputVariables
      Integer c12mode
      Integer c12variablesSelected(54)
      Common /inputcard12/c12minWavelength,c12maxWavelength,
     &     c12wavelengthInterval,c12numberOfOutputVariables,
     &     c12mode,c12variablesSelected

c     Card 13 Input
      Double Precision c13slopeAngle,c13halfApertureOpeningAngle
      Double Precision c13limitAngle
      Integer c13mode
      Common /inputcard13/c13slopeAngle,c13halfApertureOpeningAngle,
     &     c13limitAngle,c13mode

c     Card 14 Input
      Double Precision c14minWavelength,c14maxWavelength
      Double Precision c14irradianceStep,c14fullWidthHalfMaximum
      Integer c14transmittanceMode,c14mode
      Common /inputcard14/c14minWavelength,c14maxWavelength,
     &     c14irradianceStep,c14fullWidthHalfMaximum,
     &     c14transmittanceMode,c14mode

c     Card 15 Input
      Integer c15mode
      Common /inputcard15/c15mode

c     Card 16 Input
      Integer c16mode
      Common /inputcard16/c16mode

c     Card 17 Input
      Double Precision c17zenithAngle,c17azimuthalAngle
      Double Precision c17elevationAngle,c17relativeAirMass
      Double Precision c17latitude,c17longitude,c17timeInterval
      Integer c17year,c17month,c17day,c17hour,c17zone,c17mode
      Common /inputcard17/c17zenithAngle,c17azimuthalAngle,
     &     c17elevationAngle,c17relativeAirMass,c17latitude,
     &     c17longitude,c17timeInterval,c17year,c17month,
     &     c17day,c17hour,c17zone,c17mode


ccccccccccccccccc Input parameter passing end cccccccccccccccccccccccc
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc

ccccccccccccccccc Output parameter passing ccccccccccccccccccccccccccc

c     Output all requested information
      Double Precision  outputBinValues(55,2100)
      Integer           outputBinNumber
      Integer           outputHeaderNumber
      Character(len=25) outputHeaders(55)

      Common /smartsoutputs/outputBinValues,outputBinNumber,
     &     outputHeaderNumber,outputHeaders

cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
ccccccccccccccccc Output parameter passing end ccccccccccccccccccccccc

c     Set the verbosity levels
      errorVerbosity = 1
      debugVerbosity = 2
      allVerbosity   = 3

C     initialize number of bins to zero
      outputBinNumber = 0
...
c===================================
c
c     From the environment get the directory path to the share directory
c     where the data files are all located.
      call get_environment_variable("PVTREE_SHARE_PATH", 
     &     shareDirectoryPath)
      dataDirectoryPath = trim(shareDirectoryPath)//"/smarts/"

      if(verbosity .ge. debugVerbosity) then
         write(*,*) "Configured data path = "//dataDirectoryPath
      endif
...
c
      ...
      if(verbosity .ge. allVerbosity) write(6,314,iostat=Ierr1) smart
 314  format(/,35('*'),/,a48,/,35('*'))

c     Hardcode output filenames
      FileOut='smarts.debug.out.txt'
      FileExt='smarts.debug.ext.txt'
      FileScn='smarts.debug.scn.txt'
c
c**********************************************************************
c
c
      ...
      if (writeOutputFiles.eq.1) 
     &     OPEN (UNIT=16,FILE=FileOut,STATUS='NEW')
      OPEN (UNIT=22,FILE=trim(dataDirectoryPath)//'Gases/Abs_O2.dat',
     &     STATUS='OLD')
      OPEN (UNIT=25,FILE=trim(dataDirectoryPath)//'Gases/Abs_O4.dat',
     &     STATUS='OLD')
      OPEN (UNIT=26,FILE=trim(dataDirectoryPath)//'Gases/Abs_N2.dat',
     &     STATUS='OLD')
      OPEN (UNIT=27,FILE=trim(dataDirectoryPath)//'Gases/Abs_N2O.dat',
     &     STATUS='OLD')
      OPEN (UNIT=28,FILE=trim(dataDirectoryPath)//'Gases/Abs_NO.dat',
     &     STATUS='OLD')
      OPEN (UNIT=29,FILE=trim(dataDirectoryPath)//'Gases/Abs_NO2.dat',
     &     STATUS='OLD')
      OPEN (UNIT=30,FILE=trim(dataDirectoryPath)//'Gases/Abs_NO3.dat',
     &     STATUS='OLD')
      OPEN (UNIT=31,FILE=trim(dataDirectoryPath)//'Gases/Abs_HNO3.dat',
     &     STATUS='OLD')
      OPEN (UNIT=32,FILE=trim(dataDirectoryPath)//'Gases/Abs_SO2U.dat',
     &     STATUS='OLD')
      OPEN (UNIT=33,FILE=trim(dataDirectoryPath)//'Gases/Abs_SO2I.dat',
     &     STATUS='OLD')
      OPEN (UNIT=34,FILE=trim(dataDirectoryPath)//'Gases/Abs_CO.dat',
     &     STATUS='OLD')
      OPEN (UNIT=35,FILE=trim(dataDirectoryPath)//'Gases/Abs_CO2.dat',
     &     STATUS='OLD')
      OPEN (UNIT=36,FILE=trim(dataDirectoryPath)//'Gases/Abs_CH4.dat',
     &     STATUS='OLD')
      OPEN (UNIT=37,FILE=trim(dataDirectoryPath)//'Gases/Abs_NH3.dat',
     &     STATUS='OLD')
      OPEN (UNIT=38,FILE=trim(dataDirectoryPath)//'Gases/Abs_BrO.dat',
     &     STATUS='OLD')
      OPEN (UNIT=39,FILE=trim(dataDirectoryPath)//'Gases/Abs_CH2O.dat',
     &     STATUS='OLD')
      OPEN (UNIT=40,FILE=trim(dataDirectoryPath)//'Gases/Abs_HNO2.dat',
     &     STATUS='OLD')
      OPEN (UNIT=41,FILE=trim(dataDirectoryPath)//'Gases/Abs_ClNO.dat',
     &     STATUS='OLD')
      read(22,*)dummy
      read(25,*)dummy
      read(26,*)dummy
...
C     Initialize some variables in case goto 998 occurs
      iscan = 0
      iprt  = 0
      hglobs = 0.0
      hglob = 0.0
...
C     Initialize some other reasonable defaults
      iotot = 0

c     Initialize aerosol asymmetry to avoid false positive warning
      aerosolAss = 0.0
...
C
      SPR = real(c2pressure,4)
      Altit = real(c2altitude,4)
      Height = real(c2height,4)
      Zalt=Altit+Height
      if(Zalt.le.100.)goto 300
      if (verbosity .ge. errorVerbosity) write(6,1599)
...
C
 ...
 295  continue
      ...
      PHI2=Latit*Latit
      PCOR1=.993+2.0783E-04*alati-1.1589E-06*real(PHI2,4)
      PCOR2=8.855E-03-1.5236E-04*alati-9.2907E-07*real(PHI2,4)
...
C
      IF(iAtmos.EQ.0) THEN
      TAIR = real(c3temperature,4)
      RH = real(c3relativehumidity,4)
      SEASON = c3season
      TDAY = real(c3dailytemperature,4)
      ENDIF
      ...
      if(iAtmos.NE.0.and.iAtmos.NE.1) then
         write(*,*)"smarts295.f:runsmarts:iAtmos needs to be 0 or 1."
         stop(1)
      endif
...
C***      CARD 4a if IH2O=0
C
      W = real(c4precipitablewater,4)
C
 328  CONTINUE
      if(w.le.12.)goto 327
      if (verbosity .ge. errorVerbosity) write(6,1027,iostat=Ierr5)w
 ...
 327  continue
      if(w.le.0.)goto 776
      OPEN (UNIT=21,FILE=trim(dataDirectoryPath)//'Gases/Abs_H2O.dat',
     &     STATUS='OLD')
      read(21,*)dummy
 776  continue
      TEMPO=TEMPA
...
C
 ...
 348  continue
      AbO3=O3REF
      UOC=AbO3
      OPEN (UNIT=23,FILE=trim(dataDirectoryPath)//'Gases/Abs_O3UV.dat',
     &     STATUS='OLD')
      OPEN (UNIT=24,FILE=trim(dataDirectoryPath)//'Gases/Abs_O3IR.dat',
     &     STATUS='OLD')
      read(23,*)dummy
      read(24,*)dummy
      goto 335
...
C
 331  continue
      IALT = c5altitudeCorrectionMode
      AbO3 = real(c5ozoneTotalAbundance,4)
...
c
      if(iLoad.eq.0)then 
         ApCH2O = real(c6formaldehydeConcentration,4)
         ApCH4  = real(c6methaneConcentration,4)
         ApCO   = real(c6carbonMonoxideConcentration,4)
         ApHNO2 = real(c6nitrousAcidConcentration,4)
         ApHNO3 = real(c6nitricAcidConcentration,4)
         ApNO   = real(c6nitricOxideConcentration,4)
         ApNO2  = real(c6nitrogenDioxideConcentration,4)
         ApNO3  = real(c6nitrogenTrioxideConcentration,4)
         ApO3   = real(c6ozoneConcentration,4)
         ApSO2  = real(c6sulfurDioxideConcentration,4)
      endif
c
...
C
      qCO2 = real(c7carbonDioxideConcentration,4)
c
C***      CARD 7a - Changed in 2.9!! Choose ET spectrum
C
      Ispctr = c7extraterrestrialSpectrum
      
      if(Ispctr.lt.-1.or.Ispctr.gt.8)Ispctr=0
      if(ispctr.eq.-1)OPEN (UNIT=15,
     1     FILE=trim(dataDirectoryPath)//'Solar/Spctrm_U.dat',
     &     STATUS='OLD')
      if(ispctr.eq.0)OPEN (UNIT=15,
     1     FILE=trim(dataDirectoryPath)//'Solar/Spctrm_0.dat',
     &     STATUS='OLD')
      if(ispctr.eq.1)OPEN (UNIT=15,
     1     FILE=trim(dataDirectoryPath)//'Solar/Spctrm_1.dat',
     &     STATUS='OLD')
      if(ispctr.eq.2)OPEN (UNIT=15,
     1     FILE=trim(dataDirectoryPath)//'Solar/Spctrm_2.dat',
     &     STATUS='OLD')
      if(ispctr.eq.3)OPEN (UNIT=15,
     1     FILE=trim(dataDirectoryPath)//'Solar/Spctrm_3.dat',
     &     STATUS='OLD')
      if(ispctr.eq.4)OPEN (UNIT=15,
     1     FILE=trim(dataDirectoryPath)//'Solar/Spctrm_4.dat',
     &     STATUS='OLD')
      if(ispctr.eq.5)OPEN (UNIT=15,
     1     FILE=trim(dataDirectoryPath)//'Solar/Spctrm_5.dat',
     &     STATUS='OLD')
      if(ispctr.eq.6)OPEN (UNIT=15,
     1     FILE=trim(dataDirectoryPath)//'Solar/Spctrm_6.dat',
     &     STATUS='OLD')
      if(ispctr.eq.7)OPEN (UNIT=15,
     1     FILE=trim(dataDirectoryPath)//'Solar/Spctrm_7.dat',
     &     STATUS='OLD')
      if(ispctr.eq.8)OPEN (UNIT=15,
     1     FILE=trim(dataDirectoryPath)//'Solar/Spctrm_8.dat',
     &     STATUS='OLD')
c
C
C***      CARD 8
C
      AEROS = c8aerosolModel

      IF(AEROS.NE.'USER') GOTO 350
C
C***      CARD 8a if AEROS='USER'
C
      ALPHA1 = real(c8alphaShortWavelength,4)
      ALPHA2 = real(c8alphaLongWavelength,4)
      OMEGL  = real(c8singleScatteringAlbedo,4)
      aerosolAss = real(c8aerosolAsymmetry,4)
...
C
C      COEFFICIENTS FOR AEROSOLASS (ASYMMETRY FACTOR)
C
...
C
      ...
      if (verbosity .ge. errorVerbosity) write(6,1949)
...
C
      TAU5 = real(c9aerosolOpticalDepth500,4)
...
C
 351  continue
      BETA = real(c9angstromTurbidityCoefficient,4)
...
C
      BCHUEP = real(c9schueppTurbidityCoefficient,4)
...
C
 3560 continue
      Tau550 = real(c9aerosolOpticalDepth550,4)
 ...
 1824 continue
      ...
      if (verbosity .ge. errorVerbosity)
...
C
      VISI = real(c9prevailingVisibility,4)
      RANGE=1.306*VISI
      GOTO 356
 353  CONTINUE
C
...
C
      RANGE = real(c9meteorologicalRange,4)
 356  CONTINUE
C
...
C
      ...
      if (verbosity .ge. errorVerbosity) Write(6,192)
...
C
 383  continue
      Rhox = real(c10broadbandLambertianAlbedo,4)
...
C      
      ...
      if(height.gt.0.5 .and. verbosity.ge.debugVerbosity)write(6,1314)
...
C***      CARD 10c
C      
      Ialbdg = c10bforegroundAlbedoMode
      TILT = real(c10btiltAngle,4)
      WAZIM = real(c10bsurfaceAzimuth,4)
c      
      Rhog=Rhox
...
C***      CARD 10d
C      
      Rhog=real(c10bforegroundAlbedo,4)
c      
      Goto 389
 385  Continue
      Filen2=Filen1
...
C
      WLMN = real(c11minWavelength,4)
      WLMX = real(c11maxWavelength,4)
      Suncor = real(c11sunCorrectionFactor,4)
      SolarC = real(c11solarConstant,4)
...
C      
      WPMN = real(c12minWavelength,4)
      WPMX = real(c12maxWavelength,4)
      INTVL= real(c12wavelengthInterval,4)
      
      IF(INTVL.LT.0.5 .and. verbosity.ge.debugVerbosity)WRITE(6,198)
...
C      
      IOTOT = c12numberOfOutputVariables
C
C***      CARDS 12c if IPRT=2 TO 3
C      
      IOUT = c12variablesSelected
c
c=======================================         
...
C
      slope = real(c13slopeAngle,4)
      apert = real(c13halfApertureOpeningAngle,4)
      limit = real(c13limitAngle,4)
      Icirc=-2
...
C
      ...
      IFILT = c14transmittanceMode
      WV1  = real(c14minWavelength,4)
      WV2  = real(c14maxWavelength,4)
      step = real(c14irradianceStep,4)
      FWHM = real(c14fullWidthHalfMaximum,4)
      if (writeOutputFiles.eq.1) 
...
C
      ...
      OPEN (UNIT=19,
     &     FILE=trim(dataDirectoryPath)//'CIE_data/VLambda.dat',
     &     STATUS='OLD')
      Read(19,*)dummy
C
C      PHOTOMETRIC DATA
C
 ...
 403  continue
      OPEN (UNIT=19,
     &     FILE=trim(dataDirectoryPath)//'CIE_data/VMLambda.dat',
     &     STATUS='OLD')
      Read(19,*)dummy
      Do 404 IV=1,513
      READ(19,*)wvli,VL(IV)
...
c
      ...
      if(writeOutputFiles.eq.1) WRITE(16,171,iostat=Ierr17) Area,RHOX
 ...
 451  Continue
      IF(ICIRC.ge.1 .and. writeOutputFiles.eq.1)
     &     WRITE(16,115,iostat=Ierr19)slope,APERT,limit
 115  FORMAT('* GEOMETRY (half-angles) OF THE SIMULATED RADIOMETER ',
     2 '(deg.):',/,'   Slope = ',F5.2,'      Aperture = ',F5.2,
     3 '   Limit = ',F5.2,/)
      If (Icirc.eq.-2 .and. writeOutputFiles.eq.1) Write(16,151)
 151  Format('** WARNING #10',9('*'),/,'\\ The values of both Apert ',
     ...
     4 'is therefore skipped!',/)
      If(Icirc.eq.1 .and. writeOutputFiles.eq.1) Write(16,152)
 152  Format('** WARNING #11',9('*'),/'\\ The radiometer''s Slope ',
     ...
     4 'try corresponding to the Aperture angle.',/)
      If(Icirc.eq.-1 .and. writeOutputFiles.eq.1) Write(16,153)
 153  Format('** WARNING #12',9('*'),/,'\\ Circumsolar calculations ',
     ...
     2 ' be < 10 deg.',/)
      ...
      if(writeOutputFiles.eq.1) WRITE(16,171) Area,RHOG
      Goto 464
 454  continue
      if(writeOutputFiles.eq.1) Write(16,173) Area, Filen2,Lambr2
 464  Continue
C
...
C     Kill the looping feature since I can
C     just call the subroutine again!
      if(nread.GT.1) Goto 998

c     Set zone to a default value
      zone=0
...
C
      ELEV = real(c17elevationAngle,4)
      Azim = real(c17azimuthalAngle,4)
      Zenit=90.-ELEV
...
C
      ...
      if(verbosity.ge.errorVerbosity) write(6,1099,iostat=Ierr20)testx
...
c
 ...
 3    CONTINUE
      ...
      if(verbosity.ge.errorVerbosity) WRITE(6,103,iostat=Ierr24)Zenit
...
C
 4    continue
      AMASS = real(c17relativeAirMass,4)
      Azim=180.
...
C
 ...
 99   continue
      ...
      if(verbosity.ge.errorVerbosity) Write(6,109,iostat=Ierr25)Amass
...
c
 ...
 5002 continue
      ...
      AtClNO=AbClNO
c      
      if(iday.eq.1.and.jday.le.1 .and. writeOutputFiles.eq.1)
     &     Write(16,102,iostat=ierr30)Load,
...
C
 ...
 10   CONTINUE
      ...
      RD=RDC+RDH0*RDS
      if(imass.ne.4 .and. writeOutputFiles.eq.1) 
     &     WRITE(16,112,iostat=ierr31)TILT,WAZIM,TETAS,Rdi,Rd
...
C
      ...
      Scor2=SolarC/Esc
c 
      if(iday.eq.1 .and. writeOutputFiles.eq.1)
     &     write(16,126)ESCC,
     1 SUNCOR,SolarC,Spctrm
      If(abs(Scor2-1.).gt.1e-4.and.iday.eq.1.and.jday.le.1 
     &     .and. writeOutputFiles.eq.1)
     &     write(16,127)Scor2
c
      if(imass.eq.4.and.iday.eq.1 .and. writeOutputFiles.eq.1)
     &     write(16,1001)month,
     1 Real(Latit),srise,daylth,Dstep
c
 788  continue
...
C
      ...
      if (writeOutputFiles.eq.1) WRITE(16,110)
 ...
 60   continue
      ...
      if (writeOutputFiles.eq.1) WRITE(16,114)
 ...
 61   continue
      ...
      if (writeOutputFiles.eq.1) WRITE(16,111)
 111  FORMAT('*** IRRADIANCES IN W/m2 nm FOR A ',
     ...
     8  3X,'-------- TILTED -------',/)
      GOTO 65
 62   CONTINUE
      if (writeOutputFiles.eq.1) WRITE(16,116)
...
C     Store the header information in a common block as well
C     Need to terminate the strings properly for C++
C     Basically mirroring the above write to file 17
      outputHeaderNumber = IOTOT+1
      outputHeaders(1) = 'Wvlgth'//CHAR(0)
      do 8005 i=1,IOTOT
         outputHeaders(i+1) = Out(Iout(i))//CHAR(0)
 8005 continue
 5008 continue
C
c-----------------------------------------------
...
C
      ...
      aerosolAss=.71
      if(wvln.gt.500.)aerosolAss=.675
 40   continue
      if(IAER.ne.11)goto 44
      aerosolAss=.89
      if(wvln.gt.500.)aerosolAss=.85
 44   continue
 ...
 42   CONTINUE
      ...
      aerosolAss=AG0(IAER)+AG1(IAER)*WVL+AG2(IAER)*WVL2+AG3(IAER)
     % *WVL3+AG4(IAER)*WVL4
 43   CONTINUE
      aerosolAss=MIN(0.99,aerosolAss)
      ALG=log(1.-aerosolAss)
...
c     SWA should always be initialized if itilt != 0
...
C
      ...
      if(writeOutputFiles.eq.1)
     &     WRITE(16,128,iostat=ierr6)WVLN,H0,real(DIR),Real(DirH),
     &     Real(Dif),Real(Glob),Real(DRay),Real(DAer)
 128  FORMAT(f7.1,1X,F7.3,2X,7(E11.5,1X))
      goto 426
 422  continue
      IF(Itilt.ne.0.or.Icirc.ne.1)goto 423
      if(writeOutputFiles.eq.1)
     &     WRITE(16,120,iostat=ierr37)WVLN,H0,real(DIR),Real(Dif),
     &     Real(Glob),Real(DirExp),Real(DifExp),Real(DRay),Real(DAer)
 120  FORMAT(f7.1,1X,F7.3,2X,3(E11.5,1X),2X,5(E11.5,1X))
      goto 426
 423  continue
      IF(Itilt.ne.1.or.Icirc.ne.0)goto 424
      if(writeOutputFiles.eq.1)
     &     WRITE(16,124,iostat=ierr38)WVLN,H0,real(DIR),Real(Dif),
     &     Real(Glob),Real(DifS),Real(GlobS)
 124  FORMAT(f7.1,1X,F7.3,2X,3(E11.5,1X),2X,2(E11.5,1X))
      GOTO 426
 424  CONTINUE
      if(writeOutputFiles.eq.1)
     &     WRITE(16,125,iostat=ierr39)WVLN,H0,real(DIR),Real(Dif),
     &     Real(Glob),Real(DirExp),Real(DifS),Real(GlobS)
...
c     Increase the bin number to be filled
      outputBinNumber=outputBinNumber+1
      outputBinValues(1,outputBinNumber) = WVLN
      do 8006 io=1,IOTOT
         outputBinValues(io+1,outputBinNumber) = Xout(io)
 8006 continue
...
c
 ...
 155  FORMAT(' SMOOTHED RESULTS TO SIMULATE A ',F5.2,' nm FWHM',
     ...
     2 ' Shape selected: ',A12)
      if (writeOutputFiles.eq.1) WRITE(18,193)
...
c
      ...
      if (verbosity .ge. allVerbosity) write(6, 9910) TotTime
...
c
      ...
      character(len=500) :: dataDirectoryPath
      Common /Pathing/ dataDirectoryPath
c
...
c      Nfile=Max(19,18+Ialbd)
      ...
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/SNOW.DAT',
     &     STATUS='OLD')
      Name='FRESH_SNOW'
      Goto 300
 4    continue
      If(Ialbd.ne.4)goto 5
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/NEVE.DAT',
     &     STATUS='OLD')
      Name='MOUNTAIN_NEVE'
      Goto 300
 5    continue
      If(Ialbd.ne.5)goto 6
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/BASALT.DAT',
     &     STATUS='OLD')
      Name='BASALT_ROCK'
      Goto 300
 6    continue
      If(Ialbd.ne.6)goto 7
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/DRY_SAND.DAT',
     &     STATUS='OLD')
      Name='DRY_SAND'
      Goto 300
 7    continue
      If(Ialbd.ne.7)goto 8
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/WITESAND.DAT',
     &     STATUS='OLD')
      Name='WHITE_SANDS'
      Goto 300
 8    continue
      If(Ialbd.ne.8)goto 9
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/SOIL.DAT',
     &     STATUS='OLD')
      Name='SOIL'
      Goto 300
 9    continue
      If(Ialbd.ne.9)goto 10
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/Dry_clay.dat',
     &     STATUS='OLD')
      Name='DRY_CLAY_SOIL'
      Goto 300
 10   continue
      If(Ialbd.ne.10)goto 11
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/WETCLAY.DAT',
     &     STATUS='OLD')
      Name='WET_CLAY_SOIL'
      Goto 300
 11   continue
      If(Ialbd.ne.11)goto 12
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/ALFALFA.DAT',
     &     STATUS='OLD')
      Name='ALFALFA'
      Goto 300
 12   continue
      If(Ialbd.ne.12)goto 13
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/GRASS.DAT',
     &     STATUS='OLD')
      Name='GRASS'
      Goto 300
 13   continue
      If(Ialbd.ne.13)goto 14
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/RYEGRASS.DAT',
     &     STATUS='OLD')
      Name='RYE_GRASS'
      Goto 300
 14   continue
      If(Ialbd.ne.14)goto 15
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/MEADOW1.DAT',
     &     STATUS='OLD')
      Name='ALPINE_MEADOW'
      Goto 300
 15   continue
      If(Ialbd.ne.15)goto 16
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/MEADOW2.DAT',
     &     STATUS='OLD')
      Name='LUSH_MEADOW'
      Goto 300
 16   continue
      If(Ialbd.ne.16)goto 17
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/WHEAT.DAT',
     &     STATUS='OLD')
      Name='WHEAT'
      Goto 300
 17   continue
      If(Ialbd.ne.17)goto 18
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/PINETREE.DAT',
     &     STATUS='OLD')
      Name='PONDEROSA_PINE_TREE'
      Goto 300
 18   continue
      If(Ialbd.ne.18)goto 19
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/CONCRETE.DAT',
     &     STATUS='OLD')
      Name='CONCRETE'
      Goto 300
 19   continue
      If(Ialbd.ne.19)goto 20
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/BlckLoam.dat',
     &     STATUS='OLD')
      Name='BLACK_LOAM'
      Goto 300
 20   continue
      If(Ialbd.ne.20)goto 21
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/BrwnLoam.dat',
     &     STATUS='OLD')
      Name='BROWN_SANDY_LOAM'
      Goto 300
 21   continue
      If(Ialbd.ne.21)goto 22
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/BrwnSand.dat',
     &     STATUS='OLD')
      Name='BROWN_LOAMY_FINE_SAND'
      Goto 300
 22   continue
      If(Ialbd.ne.22)goto 23
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/Conifers.dat',
     &     STATUS='OLD')
      Name='CONIFER_TREES'
      Goto 300
 23   continue
      If(Ialbd.ne.23)goto 24
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/DarkLoam.dat',
     &     STATUS='OLD')
      Name='BROWN_SILT_LOAM'
      Goto 300
 24   continue
      If(Ialbd.ne.24)goto 25
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/DarkSand.dat',
     &     STATUS='OLD')
      Name='BROWN_LOAMY_SAND'
      Goto 300
 25   continue
      If(Ialbd.ne.25)goto 26
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/Decidous.dat',
     &     STATUS='OLD')
      Name='DECIDUOUS_TREES'
      Goto 300
 26   continue
      If(Ialbd.ne.26)goto 27
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/DryGrass.dat',
     &     STATUS='OLD')
      Name='DRY_GRASS'
      Goto 300
 27   continue
      If(Ialbd.ne.27)goto 28
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/DuneSand.dat',
     &     STATUS='OLD')
      Name='WHITE_DUNE_SAND'
      Goto 300
 28   continue
      If(Ialbd.ne.28)goto 29
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/FineSnow.dat',
     &     STATUS='OLD')
      Name='FINE_SNOW'
      Goto 300
 29   continue
      If(Ialbd.ne.29)goto 30
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/GrnGrass.dat',
     &     STATUS='OLD')
      Name='GREEN_GRASS'
      Goto 300
 30   continue
      If(Ialbd.ne.30)goto 31
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/GrnlSnow.dat',
     &     STATUS='OLD')
      Name='GRANULAR_SNOW'
      Goto 300
 31   continue
      If(Ialbd.ne.31)goto 32
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/LiteClay.dat',
     &     STATUS='OLD')
      Name='LIGHT_BROWN_CLAY'
      Goto 300
 32   continue
      If(Ialbd.ne.32)goto 33
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/LiteLoam.dat',
     &     STATUS='OLD')
      Name='LIGHT_BROWN_LOAM'
      Goto 300
 33   continue
      If(Ialbd.ne.33)goto 34
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/LiteSand.dat',
     &     STATUS='OLD')
      Name='LIGHT_BROWN_LOAMY_SAND'
      Goto 300
 34   continue
      If(Ialbd.ne.34)goto 35
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/PaleLoam.dat',
     &     STATUS='OLD')
      Name='PALE_BROWN_LOAM'
      Goto 300
 35   continue
      If(Ialbd.ne.35)goto 36
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/Seawater.dat',
     &     STATUS='OLD')
      Name='SEA_WATER'
      Goto 300
 36   continue
      If(Ialbd.ne.36)goto 37
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/SolidIce.dat',
     &     STATUS='OLD')
      Name='SOLID_ICE'
      Goto 300
 37   continue
      If(Ialbd.ne.37)goto 38
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/Dry_Soil.dat',
     &     STATUS='OLD')
      Name='DRY_SOIL'
      Goto 300
 38   continue
      If(Ialbd.ne.38)goto 39
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/LiteSoil.dat',
     &     STATUS='OLD')
      Name='LIGHT_SANDY_SOIL'
      Goto 300
 39   continue
      If(Ialbd.ne.39)goto 40
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/RConcrte.dat',
     &     STATUS='OLD')
      Name='OLD_RUNWAY_CONCRETE'
      Goto 300
 40   continue
      If(Ialbd.ne.40)goto 41
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/RoofTile.dat',
     &     STATUS='OLD')
      Name='TERRACOTA_ROOFING_TILE'
      Goto 300
 41   continue
      If(Ialbd.ne.41)goto 42
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/RedBrick.dat',
     &     STATUS='OLD')
      Name='RED_BRICK'
      Goto 300
 42   continue
      If(Ialbd.ne.42)goto 43
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/Asphalt.dat',
     &     STATUS='OLD')
      Name='OLD_RUNWAY_ASPHALT'
      Goto 300
 43   continue
      If(Ialbd.ne.43)goto 44
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/TallCorn.dat',
     &     STATUS='OLD')
      Name='TALL_GREEN_CORN'
      Goto 300
 44   continue
      If(Ialbd.ne.44)goto 45
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/SndGrvl.dat',
     &     STATUS='OLD')
      Name='SAND_&_GRAVEL'
      Goto 300
 45   continue
      If(Ialbd.ne.45)goto 46
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/Fallow.dat',
     &     STATUS='OLD')
      Name='FALLOW_FIELD'
      Goto 300
 46   continue
      If(Ialbd.ne.46)goto 47
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/WetClay2.dat',
     &     STATUS='OLD')
      Name='WET_RED_CLAY'
      Goto 300
 47   continue
      If(Ialbd.ne.47)goto 48
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/WetSSoil.dat',
     &     STATUS='OLD')
      Name='WET_SANDY_SOIL'
      Goto 300
 48   continue
      If(Ialbd.ne.48)goto 49
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/Gravel.dat',
     &     STATUS='OLD')
      Name='GRAVEL'
      Goto 300
 49   continue
 ...
 50   continue
      ...
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/WetSilt.dat',
     &     STATUS='OLD')
      Name='WET_SILT'
      Goto 300
 51   continue
      If(Ialbd.ne.51)goto 52
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/LngGrass.dat',
     &     STATUS='OLD')
      Name='DRY_LONG_GRASS'
      Goto 300
 52   continue
      If(Ialbd.ne.52)goto 53
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/LwnGrass.dat',
     &     STATUS='OLD')
      Name='GENERIC_LAWN_GRASS'
      Goto 300
 53   continue
      If(Ialbd.ne.53)goto 54
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/OakTree.dat',
     &     STATUS='OLD')
      Name='DECIDOUS_OAK_TREE_LEAVES'
      Goto 300
 54   continue
      If(Ialbd.ne.54)goto 55
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/Pinion.dat',
     &     STATUS='OLD')
      Name='PINON_PINETREE_NEEDLES'
      Goto 300
 55   continue
      If(Ialbd.ne.55)goto 56
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/MeltSnow.dat',
     &     STATUS='OLD')
      Name='MELTING_SNOW=SLUSH'
      Goto 300
 56   continue
      If(Ialbd.ne.56)goto 57
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/Plywood.dat',
     &     STATUS='OLD')
      Name='PLYWOOD_SHEET'
      Goto 300
 57   continue
      If(Ialbd.ne.57)goto 58
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/WiteVinl.dat',
     &     STATUS='OLD')
      Name='WHITE_VINYL_COVER_SHEET'
      Goto 300
 58   continue
      If(Ialbd.ne.58)goto 59
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/FibrGlss.dat',
     &     STATUS='OLD')
      Name='CLEAR_FIBERGLASS_COVER'
      Goto 300
 59   continue
      If(Ialbd.ne.59)goto 60
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/ShtMetal.dat',
     &     STATUS='OLD')
      Name='GALVANIZED_SHEET_METAL'
      Goto 300
 60   continue
      If(Ialbd.ne.60)goto 61
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/Wetland.dat',
     &     STATUS='OLD')
      Name='WETLAND_CANOPY'
      Goto 300
 61   continue
      If(Ialbd.ne.61)goto 62
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/SageBrsh.dat',
     &     STATUS='OLD')
      Name='SAGEBRUSH_CANOPY'
      Goto 300
 62   continue
      If(Ialbd.ne.62)goto 63
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/FirTrees.dat',
     &     STATUS='OLD')
      Name='FIR_TREES_COLORADO'
      Goto 300
 63   continue
      If(Ialbd.ne.63)goto 64
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/CSeaWatr.dat',
     &     STATUS='OLD')
      Name='COASTAL_PACIFIC_SEAWATER'
      Goto 300
 64   continue
      If(Ialbd.ne.64)goto 65
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/OSeaWatr.dat',
     &     STATUS='OLD')
 ...
 65   continue
      ...
      Open (UNIT=20,
     &     FILE=trim(dataDirectoryPath)//'Albedo/GrazingField.dat',
     &     STATUS='OLD')
      Name='GRAZING_FIELD'
      Goto 300
 66   continue
      If(Ialbd.ne.66)goto 2
      Open (UNIT=20,FILE=trim(dataDirectoryPath)//'Albedo/Spruce.dat',
     &     STATUS='OLD')
      Name='SPRUCE_TREE'
      Goto 300
c      
 2    continue
      ...
      Return
 1    continue
      If(Ialbd.LE.1)Open (UNIT=20,
     &     FILE=trim(dataDirectoryPath)//'Albedo/ALBEDO.DAT',
     &     STATUS='OLD')
      Name='USER_DEFINED'
 300  Continue
      Ial=1
...
c     Check how sensible v1 and vu are?
...
c     Perform a check of index finding
      if(J1.eq.-1) then
         write(*,*)"smarts295.f:ozon: J1 not found."
         stop 1
      endif
...
c     Perform a check of index finding
      if(J1.eq.-1) then
         write(*,*)"smarts295.f:ozon2: J1 not found."
         stop 1
      endif      
...
c     Initialize indicies to error value
      IRH1=-1
...
c     Check humidity indicies have been set correctly
      if(IRH1.eq.-1) then
         write(*,*)"smarts295.f:phase1:Humidity indicy IRH1 have not 
     & been found."
         stop(1)         
      endif
...
c     Check wavelength indicies have been set correctly
      if(IWV1.eq.-1) then
         write(*,*)"smarts295.f:phase1:Boundary indicy IWV1 have not 
     & been found."
         stop(1)         
      endif
...
c     Perform a check of index finding
      if(index.eq.-1) then
         write(*,*)"smarts295.f:ScantG: Index not found."
         stop 1
      endif
...
c     Perform a check of index finding
      if(index.eq.-1) then
         write(*,*)"smarts295.f:ScantT: Index not found."
         stop 1
      endif
...
c
     ...
     3 sinLat
      Double Precision R,xsun,EOT,ELD,ELD2,REFR
c
c
